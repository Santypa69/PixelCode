...
// Simulamos algunas preguntas sobre variables en PHP
$questions = [
    1 => ['question' => '¿Cómo se declara una variable en PHP?', 'answer' => '$var = 10;'],
    2 => ['question' => '¿Cómo se declara una variable y se le asigna un valor al mismo tiempo en PHP?', 'answer' => '$var = "Hola Mundo";'],
    3 => ['question' => '¿Cómo se puede imprimir el valor de una variable en PHP?', 'answer' => 'echo $var;'],
    4 => ['question' => '¿Las variables en PHP son sensibles a mayúsculas y minúsculas?', 'answer' => 'Sí'],
    5 => ['question' => '¿Cómo se puede definir una constante en PHP?', 'answer' => 'define("MI_CONSTANTE", 100);'],
];
...
<head>
    ...
    <title>Ejercicios de Variables en PHP</title>
    <style>
        /* General Styles */
        body {
...
<body>
    ...
    <div class="container">
        <h1>Ejercicios sobre Variables en PHP</h1>
        <h2>Recuerda que las variables en PHP siempre comienzan con el signo $</h2>
        ...
        <?php if ($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
            ...
            <div class="result">
                ...
                <a href="http://localhost/my%20project/ejercicios/vari.php" class="retry-link">Volver a intentarlo</a>
                <a href="http://localhost/my%20project/ejercicios/if.php" class="next-page-btn">Ir a la siguiente página</a>
            </div>
        <?php else: ?>
            <form method="POST">
