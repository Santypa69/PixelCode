...
// Simulamos algunas preguntas de sintaxis
$questions = [
    1 => ['question' => '¿Cómo se declara una variable en PHP?', 'answer' => '$var = 10;'],
    2 => ['question' => '¿Cómo se imprime algo en PHP?', 'answer' => 'echo "texto";'],
    3 => ['question' => '¿Cómo se crea un array en PHP?', 'answer' => '$arr = array();'],
    4 => ['question' => '¿Cuál es el operador de concatenación en PHP?', 'answer' => '.'],
    5 => ['question' => '¿Cómo se crea una función en PHP?', 'answer' => 'function miFuncion() {}'],
];
...
<head>
    ...
    <title>Ejercicios de PHP - Sintaxis</title>
    <style>
        /* General Styles */
        body {
...
<body>
    ...
    <div class="container">
        <h1>Ejercicios de Sintaxis PHP</h1>
        <h2>Recuerda que PHP es muy exigente con su sintaxis</h2>
        ...
        <?php if ($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
            ...
            <div class="result">
                ...
                <a href="index.php" class="retry-link">Volver a intentarlo</a>
                <a href="http://localhost/my%20project/ejercicios/come.php" class="next-page-btn">Ir a la siguiente página</a> <!-- Nuevo botón aquí -->
            </div>
        <?php else: ?>
            <form method="POST">
